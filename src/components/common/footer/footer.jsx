      ...
      <div className={styles.footer_content}>
        <div className={styles.menu_container}>
		  ...
		  <a href='/' className={styles.logo}>
            ...
            <div className={styles.menu_items}>
              ...
              <div className={styles.menu_column}>
                <h4 className={styles.menu_title}>Resources</h4>
                <a href="/" className={styles.item}>Home</a>
                <a  className={styles.item}>Services</a>
                <a  className={styles.item}>About Us</a>
                <a href="/faq/legal" className={styles.item}>FAQs</a>
              </div>

              <div className={styles.menu_column}>
                <h4 className={styles.menu_title}>Legal</h4>
                <a href="/terms-and-conditions" className={styles.item}>Terms & Conditions</a>
                <a  className={styles.item}>Privacy Policy</a>
                <a  className={styles.item}>Cookies Policy</a>
                <a  className={styles.item}>Disclaimer</a>
              </div>
              
              <div className={styles.menu_column}>
                <h4 className={styles.menu_title}>Who we are</h4>
                <a  className={styles.item}>Contact Us</a>
                <a  className={styles.item}>Our Team</a>
        ...
        <div className={styles.social_container}>
          ...
          <div className={styles.social_links}>
            ...
            <a href="#" className={styles.link_icon} aria-label="Telegram">
...
const linkedin = (
  <svg
    ...
    fill="none"
  >
    <g clipPath="url(#clip0_1_linkedin)">
      <path
        d="M16.1429 0.428589H1.71429C1.01786 0.428589 0.428589 1.01786 0.428589 1.71429V16.1429C0.428589 16.8393 1.01786 17.4286 1.71429 17.4286H16.1429C16.8393 17.4286 17.4286 16.8393 17.4286 16.1429V1.71429C17.4286 1.01786 16.8393 0.428589 16.1429 0.428589ZM5.57143 14.8571H3V6.85715H5.57143V14.8571ZM4.28571 5.71429C3.42857 5.71429 2.71429 5.00001 2.71429 4.14286C2.71429 3.28572 3.42857 2.57143 4.28571 2.57143C5.14286 2.57143 5.85714 3.28572 5.85714 4.14286C5.85714 5.00001 5.14286 5.71429 4.28571 5.71429ZM14.8571 14.8571H12.2857V10.7143C12.2857 9.85715 11.5714 9.14286 10.7143 9.14286C9.85714 9.14286 9.14286 9.85715 9.14286 10.7143V14.8571H6.57143V6.85715H9.14286V7.85715C9.57143 7.28572 10.4286 6.85715 11.1429 6.85715C13.1429 6.85715 14.8571 8.57144 14.8571 10.5714V14.8571Z"
        fill="currentColor"
      />
    </g>
    <defs>
      <clipPath id="clip0_1_linkedin">
        <rect
          width="17.1429"
          height="17.1429"
          fill="white"
