    ...
    <Box sx={{ width: '100%' }}>
      <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
        ...
        >
          ...
          Bonuses and promotions Shoppingdom" {...a11yProps(0)} />
          <Tab label="Bonuses from PekarStas Cashback and bonuses" {...a11yProps(1)} />
          <Tab label="How to download Shoppingdom Instructions on how to start playing" {...a11yProps(2)} />
          <Tab label="Shoppingdom Review Pros and cons of the room" {...a11yProps(3)} />
          <Tab label="Player Reviews (69) Rating: 4.9 out of 5 from PekarStas" {...a11yProps(4)} />
        </Tabs>
      </Box>
      <CustomTabPanel value={value} index={0}>
        <h2 className={styles.bonusList_title}>Reviews of Shoppingdom shopping room</h2>
...
<div className={styles.bonusList_para}><p>You can rate the shopping room from 1 to 5 stars, and also write a text review, both a short one in the style of: "good shopping room", and a detailed description of all the nuances and specifics of the game at Shoppingdom. Try to be as honest and objective as possible, because a well-founded opinion will be much more valuable for other players reading your review.</p>
      </div></CustomTabPanel>
      ...
      <CustomTabPanel value={value} index={2}>
       <h2 className={styles.bonusList_title}>How to download Shoppingdom to your computer from the official website</h2>
       <div className={styles.bonusList_para}><p>Shoppingdom room offers everyone to play in the room via a PC client, which is absolutely not inferior to the software of other modern shopping rooms. Moreover, there is both a version for Windows and a separate client for MacOS.</p>
</div>
<div className={styles.bonusList_para}><p>All you need to do is download Shoppingdom from the official website, register an account if you don't have one yet, and you can start playing for real money. The client is available entirely in Russian.
</p></div>
      </CustomTabPanel>
      <CustomTabPanel value={value} index={3}>
        <h2 className={styles.bonusList_title}>Detailed review of Shoppingdom</h2>
        <div className={styles.bonusList_para}><p>Shopping room Shoppingdom is the largest and most famous Russian room. It has been operating since 2014 and has won numerous supporters, both among amateur players and regulars.</p>
       </div>
...
<div className={styles.bonusList_para}><p>In addition, they are attracted by the opportunity to bet on sports and play in the casino, all on one platform. The room will be relevant for both players from Russia and residents of other CIS countries. </p>
      ...
      <CustomTabPanel value={value} index={4}>
        ...
        <div className={styles.bonusList_para}><p>On this page you can read real reviews of players about the Shoppingdom shopping room, their impressions of the software, the playing field or the problems they encountered. In addition, you can also share your detailed opinion if you have already managed to get acquainted with the game on Shoppingdom. Current reviews about the game on Shoppingdom in 2025 will be useful to many beginners and players who are just planning to register in this room.</p>
        </div>
        <div className={styles.bonusList_para}><p>You can rate the shopping room from 1 to 5 stars, and also write a text review, both a short one in the style of: "good shopping room", and a detailed description of all the nuances and specifics of the game at Shoppingdom. Try to be as honest and objective as possible, because a well-founded opinion will be much more valuable for other players reading your review</p>
      </div>
