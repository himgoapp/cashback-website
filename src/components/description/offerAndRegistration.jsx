            ...
            <div className={styles.acc_type_container}>
              <div className={styles.type_container}>
                <div className={styles.type_content}>
                  <div
                    className={`secondary_link_nav ${
                      register === 0 ? styles.active : ""
                    }`}
                  ...
                  <>
                    <div className={styles.type_desc}>
                      <div className={styles.type_title}>
                        ...
                        <div className={styles.text}>Account Verification</div>
                      </div>

                      <div className={styles.description}>
                        After registering an account through our website, fill
                        out the form below to ensure that the account has been
                        successfully linked to us.
                      </div>
                    </div>
