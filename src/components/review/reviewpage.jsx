...
import OfferShoppingIcon from "../../assets/OfferShoppingIcon.svg"
...
const reviewpage = () => {
    ...
    return (
        <div className="NewsChildpAge DesktopLatestNews dictionaryPage">
            <div class="container">
                <div className="row">
                ...
                <div className="single-post-row Dictionaryrow">
                    <div className="single-post-left">
                        ...
                        <p>Heard an unfamiliar shopping term? You’ll find it below in our alphabetical list of shopping terminology. Just click on a letter to drop down to that point, and click the red arrow on the right to slide back up.</p>
                        <p>Regardless of the type of grid you are using, the grid is made up of three elements: columns, gutters, and margins.</p>

                        <div className="article-content">
                            <div class="nav shopping-glossary-navigation ">
                            ...
                            <div class="sidePost col-lg-12">
                                <div class=" OffersForUchd LatestNewsDsg">
                                    <div class="LatestNewsDsgIMg">
                                        <img src={FeaturedCardImage} alt="Featured card" class="" />
                                    </div>
                                    <div class="LatestNewsDsgTxt">
                                        ...
                                        <div class="SliderFooter">
                                            ...
                                            <button class="Shoppingbazzi25">Shoppingbazzi25
