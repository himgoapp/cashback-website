...
import { getLabel, getWalletArray, getGameIcon, getShoppingSiteImage, backgroundClassHelper, extractHeadingsFromHTML, notRequired } from "../../helperFxns/reviewhelper";
            ...
            {loading ? <Loading size="md" /> :
                <div className="container">
                    ...
                    <div className={backgroundClassHelper(currentItem?.name)}>
                        ...
                        <div className="left">
                            <div className="logo">
                                <img src={getShoppingSiteImage(currentItem?.name)} alt={currentItem?.name || 'store logo'} />
                            </div>
                            <div className="offer">
                            ...
                            <button className="GrabDealButton GrabDealPrimary">Grab Deal</button>
                        </div>
                                    ...
                                    <div className="single-post-left">
                                        <div className="article-content">
                                            ...
                                            <div id="OfferDetails" className="">
                                                <h4>Benefits of {currentItem?.name}</h4>
                                            ...
                                            <div id="History" className="CashbackFAQ ">
                                                <h2>FAQ</h2>
                            ...
                            <div className="single-post-row Dictionaryrow taggingTab">
                                <div className="single-post-left">
                                    <div className="article-content">
                                        ...
                                        <div id="TaggingFAQ" className="CashbackFAQ ">
