  ...
  return (
    <div className={styles.deals_card}>
        ...
        <div className={styles.text_container}>
          ...
          <div className={styles.card_text_content}>
            ...
            <div className={styles.title_container}>
              <div className={styles.title}>Sign Up or Deposit Bonuses</div>
              {/* Title Content */}
            </div>
            {/* Description Container */}
            <div className={styles.description_container}>
              <div className={styles.description}>
                Get extra value and more opportunities to boost your poker
                bankroll right from the start!
              </div>
              {/* Description Content */}
            </div>
          </div>
      ...
      <div className={styles.image}>
        {/* Image Content */} <img src={img} style={{ width: "100%" }} alt="" />{" "}
      </div>
    </div>
  );
};
