        ...
        <table className="table align-middle">
          <thead>
            <tr className="">
              ...
              {transactionType !== "TDS" && <th>Store Name</th>}
              <th>Order Value</th>
              {transactionType === "TDS" && <th>TDS</th>}
              {transactionType !== "TDS" && <th>Cashback Earned</th>}
              {transactionType !== "TDS" && <th>Tracking Status</th>}
              <th>Date</th>
            </tr>
          </thead>
          <tbody>
            {transactions.map((txn, index) => (
              <tr key={index}>
                ...
                {transactionType === "TDS" && (
                  ...
                  >
                    {txn.typeOfTransaction === "Deposit"
                      ? `+₹${txn.cashbackcut.toLocaleString()}`
                      : `-₹${Math.abs(txn.cashbackcut).toLocaleString()}`}
                  </td>
                )}
                {transactionType !== "TDS" && (
                  <td className="fw-medium">
                ...
                {transactionType !== "TDS" && (
                  <td className="fw-medium">
                    <span className={`badge ${
                      txn.status === "Confirmed" ? "bg-success" : 
                      txn.status === "Cancelled" ? "bg-danger" : "bg-warning"
                    }`}>
                      {txn.status || "Pending"}
                    </span>
                  </td>
